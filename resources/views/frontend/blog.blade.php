...
@section('title_atas', 'Blog - Bliputuabdi')
@section('main')
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="standard__blog__post">
                            ...
                            <div class="standard__blog__content">
                                ...
                                <h2 class="title"><a href="{{ route('blog.details', $item->blog_slug) }}">{{ $item->blog_title }}</a></h2>
                                <p>{!! Str::limit($item->blog_description, 124) !!} </p>
                                ...
                                <ul class="rc__post">
                                    ...
                                    <li class="rc__post__item">
                                        ...
                                        <div class="rc__post__content">
                                            ...
                                            <span class="post-date"><i class="fal fa-calendar-alt"> {{ Carbon\Carbon::parse($all->created_at)->diffForHumans() }}</i> </span>
                                        </div>
                                    </li>
                                    @endforeach
                                </ul>
