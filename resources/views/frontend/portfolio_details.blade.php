            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="breadcrumb__wrap__content">
                        <h2 class="title">{{ $get_detail_portfolio->portfolio_name }}</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">{{ $get_detail_portfolio->portfolio_name }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="services__details__thumb">
                        <img src="{{ asset($get_detail_portfolio->portfolio_image) }}" alt="">
                    </div>
                    <div class="services__details__content">
                        <h2 class="title">{{ $get_detail_portfolio->portfolio_title }}</h2>
                        <p>
                            {!! $get_detail_portfolio->portfolio_description !!}
                        </p>
                    </div>
                </div>
                <div class="col-lg-4">
