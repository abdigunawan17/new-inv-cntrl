                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('update.about') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="title" value="{{ $aboutpage->title }}" type="text" placeholder="Artisanal kale" id="example-text-input">
                            </div>
                        </div>
                        <!-- end row -->
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" name="subtitle" value="{{ $aboutpage->subtitle }}" type="text" placeholder="How do I shoot web" id="example-search-input">
                            </div>
                        </div>
                        <!-- end row -->
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="example-search-input" class="col-sm-2 col-form-label">About Image</label>
                            <div class="col-sm-10">
                        ...
                        <img class="rounded avatar-lg" id="showImage" src="{{ ( !empty( $aboutpage->about_image)) ? url($aboutpage->about_image ) : url('upload/no_image.png') }}" alt="Card image cap">
                        </div>
